lte_bands = [1,2,3,66]       # 1,2,3,4,7,25,66,38,39,40,41,5,8,12,13,14,17,18,19,20,28,71,42,48
wcdma_bands = [1]
gsm_bands = []
hsupa_bands = [1]
hsdpa_bands = [1]
fr1_bands = [1,2,3,66]
band_segmment = 'A'  # 'A' | 'B' for B28A ,B28B


lte_bandwidths = [10]     # 1.4, 3, 5, 10, 15, 20
fr1_bandwidths = [10]  # 10, 15, 20, 25, 30 , 40, 50, 60, 80, 90, 100, 70

tech = ['LTE', 'FR1']   # 'LTE' | 'WCDMA' | 'GSM' | 'HSUPA' | 'HSDPA' | 'FR1'
channel = 'LMH'  # 'LMH'
...
port_tx_lte = 4  # 1 ~ 8 default is  1
